//==============================================================================
//
// 	sensor_epsonG365PDC0.h - Epson G365PDC0 sensor specific definitions
//
//
...
//
//==============================================================================
#ifndef EPSONG365PDC0_H_
#define EPSONG365PDC0_H_
...
#define EXT_SYNC_CTRL_LO 0x18     // EXT_SYNC_CTRL Byte0 (W1)
#define EXT_SYNC_CTRL_HI 0x19     // EXT_SYNC_CTRL Byte1 (W1)
...
#define CMD_INITIAL_BACKUP \
  0x10  // Write value for GLOB_CMD_LO to issue Initial_Backup
